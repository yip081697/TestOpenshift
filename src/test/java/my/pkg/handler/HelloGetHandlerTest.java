...
@Ignore
public class HelloGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(HelloGetHandlerTest.class);
    ...
    @Test
    public void testHelloGetHandlerTest() throws ClientException {
